...
var createTokens = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(user, secret, secret2) {
    var id, username, isAdmin, rest, createToken, createRefreshToken;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = user.id, username = user.username, isAdmin = user.isAdmin, rest = (0, _objectWithoutProperties3.default)(user, ['id', 'username', 'isAdmin']);
            createToken = _jsonwebtoken2.default.sign({ user: { id: id, username: username, isAdmin: isAdmin } }, secret, { expiresIn: '1d' });
            createRefreshToken = _jsonwebtoken2.default.sign({ user: { id: id } }, secret2, { expiresIn: '1w' });
...
var tryLogin = exports.tryLogin = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(username, password, models, SECRET, SECRET2) {
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return models.findByLogin(username);
